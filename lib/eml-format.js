...
emlformat.unpack2 = function(eml, directory, attPadStr, options, callback) {
  ...
  function _unpack(data) {
    try {
      ...
      if (data.attachments && data.attachments.length > 0) {
        attachmentsInDiv = `
<div class="FileList" style="background-color:Aqua; margin: 4px 0px 8px 0px; padding:4px;"><p style="margin:2px;">
&amp;:`;
        for (var i = 0; i < data.attachments.length; i++) {
          var attachment = data.attachments[i];
          var filename = attachment.name;
...
<div class="FromTo" style="background-color:LightBlue; margin:4px 0px; padding:4px;"><p style="margin:2px;">
